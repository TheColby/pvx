...
ALGORITHM_ID = 'spatial_and_multichannel.direction_of_arrival_grid_tracking'
ALGORITHM_NAME = 'Direction-of-arrival grid tracking'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Direction-of-arrival grid tracking on the provided audio buffer.
