...
ALGORITHM_ID = 'spatial_and_multichannel.diffuse_field_coherence_masking'
ALGORITHM_NAME = 'Diffuse-field coherence masking'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Diffuse-field coherence masking on the provided audio buffer.
