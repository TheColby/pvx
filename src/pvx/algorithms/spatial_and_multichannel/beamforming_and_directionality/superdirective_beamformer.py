...
ALGORITHM_ID = 'spatial_and_multichannel.superdirective_beamformer'
ALGORITHM_NAME = 'Superdirective beamformer'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Superdirective beamformer on the provided audio buffer.
