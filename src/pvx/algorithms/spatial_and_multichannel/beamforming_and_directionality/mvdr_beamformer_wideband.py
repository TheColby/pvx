...
ALGORITHM_ID = 'spatial_and_multichannel.mvdr_beamformer_wideband'
ALGORITHM_NAME = 'MVDR beamformer (wideband)'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run MVDR beamformer (wideband) on the provided audio buffer.
