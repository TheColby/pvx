...
ALGORITHM_ID = 'spatial_and_multichannel.spatial_room_impulse_convolution'
ALGORITHM_NAME = 'Spatial room impulse convolution'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Spatial room impulse convolution on the provided audio buffer.
