...
ALGORITHM_ID = 'spatial_and_multichannel.higher_order_ambisonic_rotation'
ALGORITHM_NAME = 'Higher-order ambisonic rotation'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Higher-order ambisonic rotation on the provided audio buffer.
