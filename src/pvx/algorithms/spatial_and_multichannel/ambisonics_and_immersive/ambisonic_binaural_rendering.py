...
ALGORITHM_ID = 'spatial_and_multichannel.ambisonic_binaural_rendering'
ALGORITHM_NAME = 'Ambisonic binaural rendering'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Ambisonic binaural rendering on the provided audio buffer.
