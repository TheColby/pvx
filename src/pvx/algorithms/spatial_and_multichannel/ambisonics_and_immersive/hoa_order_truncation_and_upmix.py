...
ALGORITHM_ID = 'spatial_and_multichannel.hoa_order_truncation_and_upmix'
ALGORITHM_NAME = 'HOA order truncation and upmix'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run HOA order truncation and upmix on the provided audio buffer.
