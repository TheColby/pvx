...
ALGORITHM_ID = 'spatial_and_multichannel.spherical_harmonic_diffuse_enhancement'
ALGORITHM_NAME = 'Spherical-harmonic diffuse enhancement'
THEME = 'Spatial and Multichannel'


def process(audio: np.ndarray, sample_rate: int, **params: Any) -> AlgorithmResult:
    """Run Spherical-harmonic diffuse enhancement on the provided audio buffer.
