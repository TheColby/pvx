...
def acronym_primer_html() -> str:
    return (
        "<div class=\"card\">"
        "<h2>Acronym primer</h2>"
        "<ul>"
        "<li>application programming interface (API)</li>"
        "<li>command-line interface (CLI)</li>"
        "<li>path environment variable (PATH)</li>"
        "<li>digital signal processing (DSP)</li>"
        "<li>short-time Fourier transform (STFT)</li>"
        "<li>inverse short-time Fourier transform (ISTFT)</li>"
        ...
        "<li>waveform similarity overlap-add (WSOLA)</li>"
        "<li>input/output (I/O)</li>"
        "<li>root-mean-square (RMS)</li>"
        "<li>loudness units relative to full scale (LUFS)</li>"
...
<body>
  ...
  <main class=\"wrap\">{acronym_primer_html()}{content}</main>
